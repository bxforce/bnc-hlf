...
fabric-ca-client enroll -u https://rca-${this.options.org.name}-admin:rca-${this.options.org.name}-adminpw@0.0.0.0:7054 --caname rca.${
...
fabric-ca-client register -u https://0.0.0.0:7054 --caname rca.${this.options.org.name} --id.name ${peer.name}.${this.options.org.fullName} --id.secret ${peer.name}pw --id.type peer --id.attrs '"hf.Registrar.Roles=peer"' --tls.certfiles ${this.options.networkRootPath}/organizations/fabric-ca/${this.options.org.name}/crypto/tls-cert.pem
`
  )
  .join(' ')}        
...
fabric-ca-client register --caname rca.${this.options.org.name} --id.name ${this.options.org.name}User1 --id.secret ${
  ...
  }/organizations/fabric-ca/${this.options.org.name}/crypto/tls-cert.pem
...
fabric-ca-client enroll -u https://${this.options.org.name}User1:${this.options.org.name}User1Pw@0.0.0.0:7054 --caname rca.${
  ...
  }/msp --tls.certfiles ${this.options.networkRootPath}/organizations/fabric-ca/${this.options.org.name}/crypto/tls-cert.pem
